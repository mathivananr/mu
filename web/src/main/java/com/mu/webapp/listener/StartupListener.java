...
public class StartupListener implements ServletContextListener {
	...
	public static void setupContext(ServletContext context) {
		...
		context.setAttribute(Constants.MOBILE_OPERATORS,
				mgr.getMobileOperators());
		log.debug("Drop-down mobile Operators initialization complete [OK]");

		context.setAttribute(Constants.DTH_OPERATORS, mgr.getDTHOperators());
		log.debug("Drop-down dth Operators initialization complete [OK]");

		context.setAttribute(Constants.DATACARD_OPERATORS,
